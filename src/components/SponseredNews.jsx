...
const SponseredNews = () => {
  return (
    <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 w-full flex flex-col md:flex-col mt-4 my-15">
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-white">Sponsered News</h1>
